"""
combined_pinn_lnn_refit_house5_dataset.py
=============================================
...
APR-REFIT-Scripts/combined_pinn_lnn_refit_house2_dataset.py) to House 5's own
...
POS_WEIGHT_CLAMP measured directly on House 5's own train split
   ...
   Clamped to (1.0, 60.0) accordingly.
...
def train(data_dict: dict, save_dir: str,
    ...
    with open(os.path.join(save_dir, 'combined_pinn_lnn_refit_house5_dataset_results.json'), 'w') as f:
...
def _plot_loss(history, save_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, 'combined_pinn_lnn_refit_house5_dataset_loss.png'),
...
def _plot_metrics(history, test_metrics, save_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, 'combined_pinn_lnn_refit_house5_dataset_per_appliance.png'),
                dpi=150, bbox_inches='tight')
    plt.close()
...
if __name__ == '__main__':
    ...
    save_dir  = os.path.join(
        ...
        f'combined_pinn_lnn_refit_house5_dataset_{timestamp}'
    )
