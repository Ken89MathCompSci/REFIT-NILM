...
1. DATA SOURCE -- reads directly from APR-REFIT-House2-dataset/ CSV files instead
   of the pickled data/ukdale/*_small.pkl splits:
       APR-REFIT-House2-dataset/REFIT_HF_train.csv      (House 2, auto-selected by generate_refit_house2_dataset.py)
       APR-REFIT-House2-dataset/REFIT_HF_validation.csv (House 2, auto-selected by generate_refit_house2_dataset.py)
       APR-REFIT-House2-dataset/REFIT_HF_test.csv       (House 2, auto-selected by generate_refit_house2_dataset.py)
