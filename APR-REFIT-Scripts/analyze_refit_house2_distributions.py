...
Splits (all House 2, chronologically contiguous, no gap/overlap):
    train      auto-selected by generate_refit_house2_dataset.py
    validation auto-selected by generate_refit_house2_dataset.py
    test       auto-selected by generate_refit_house2_dataset.py
