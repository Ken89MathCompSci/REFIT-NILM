...
Copied unchanged from APR-REFIT-Scripts/test_lnn_refit_house2_dataset.py into
Sep-2026-House-2-scripts/ -- REFIT House 2's counterpart to the
Sep-2026-UKDALE-scripts/ folder's test_lnn_apr_new_house5_dataset.py. Already
...
per-appliance 10/50/200/20 W, needed there for standby-floor artefacts REFIT
doesn't have).
